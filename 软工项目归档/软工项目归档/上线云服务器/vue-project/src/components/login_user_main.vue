        ...
        methods: {
            submitForm(ruleForm) {
                this.$refs[ruleForm].validate((valid) => {
                    if(valid){
                        this.axios.post('http://47.113.189.48:5011/api/register',this.ruleForm).then((resp) =>{
                            //console.log(resp);
                            let data = resp.data;
                            //console.log(data);
                            if(data.success){
            ...
            Login(){
                this.axios.post('http://47.113.189.48:5011/api/login',this.loginForm).then((resp) =>{
                    //console.log(resp);
                    let data = resp.data;
                    if(data.success){
