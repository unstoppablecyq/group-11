...
const router = new Router({
    ...
    routes: [
        ...
        },
        {
            ...
            beforeEnter: (to , from , next ) => {
                ...
                if(!gologin) {
                    ...
                    //console.log(gologin)
                    axios({
                        url: 'http://47.113.189.48:5011/api/checkToken',
                        method: 'get',
                        headers: {
                            token: gologin.token
                        }
        ...
        {
            path: "/WIJ0gfa0wdjfa988w33jfnIAINIJfaidnmgIJADia93948jkajkI92j99wjA",
            name: "WIJ0gfa0wdjfa988w33jfnIAINIJfaidnmgIJADia93948jkajkI92j99wjA",
            ...
            children: [
                ...
                },
                {
                    path: "all_users",
                    name: "all_users",
                    component:() => import("@/views/admin/all_users.vue"),
                },
            ]
        },
        {
