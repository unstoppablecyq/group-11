...
<script>
    export default {
        ...
        methods:{
            Login(){
                this.axios.post('http://47.113.189.48:5011/api/adminlogin',this.loginForm).then((resp) =>{
                    let data = resp.data;
                    if(data.success){
                        this.loginForm = {};
                        this.$message({
                        ...
                        this.$router.push('/WIJ0gfa0wdjfa988w33jfnIAINIJfaidnmgIJADia93948jkajkI92j99wjA');
                    }else{
                        this.$message({
