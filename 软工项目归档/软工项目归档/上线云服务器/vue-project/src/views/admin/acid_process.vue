...
<script>
    export default {
        ...
        methods: {
            //刷新localstorage
            getnewdata(){
                this.axios.post('http://47.113.189.48:5011/api/getnewacid').then((resp) =>{
            ...
            Yes(data){
                ...
                this.axios.post('http://47.113.189.48:5011/api/addusermsg',this.acidmsg).then((resp) =>{
            ...
            No(data){
                this.axios.post('http://47.113.189.48:5011/api/delateacid',data).then((resp) =>{
