...
<script>
    export default{
        ...
        methods:{
            getnewdata(){
                this.axios.post('http://47.113.189.48:5011/api/getnewcheckbody').then((resp) =>{
            ...
            Yes(data){
                ...
                this.axios.post('http://47.113.189.48:5011/api/addusermsg',this.checkbodymsg).then((resp) =>{
            ...
            No(data){
                console.log(data)
                this.axios.post('http://47.113.189.48:5011/api/deletecheckbody',data).then((resp) =>{
