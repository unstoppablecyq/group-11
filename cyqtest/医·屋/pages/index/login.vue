<template>
  <view class="container">
    ...
    <view class="content">
      <view class="mobile">
        <input class="mobile-input" placeholder="请输入用户名" v-model="username">
      </view>
      <view class="password">
      ...
      <view class="tail">
		...
		<view class="docdoc" @click="goDoc">医生登陆</view>
      </view>
    </view>
  </view>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      async confirm() {
        ...
        let findres = await db.collection("User_Patient").where({User_Name: this.username,PassWord:this.password}).get()
